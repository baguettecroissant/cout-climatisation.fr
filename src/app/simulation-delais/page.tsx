...
export const metadata: Metadata = {
    title: "Délais Installation Climatisation | Simulation 2026",
    description: "Combien de temps pour installer un climatisation ? Découvrez les délais moyens de fabrication et de pose selon votre modèle (droit ou tournant).",
};
        ...
        <div className="bg-slate-50 min-h-screen">
            ...
            <div className="bg-white border-b border-slate-200">
                <div className="container mx-auto px-4 py-8">
                    <Link href="/" className="inline-flex items-center text-slate-500 hover:text-cyan-600 transition-colors mb-6">
                        <ArrowLeft className="h-4 w-4 mr-2" />
                        Retour à l'accueil
                    </Link>
                    <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">
                        Délais d'installation : <span className="text-cyan-600">À quoi s'attendre ?</span>
                    </h1>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="border-b border-slate-100">
                                            <th className="py-4 font-semibold text-slate-900">Type de Climatisation</th>
                                    ...
                                    <tbody className="divide-y divide-slate-100">
                                        ...
                                        <tr>
                                            ...
                                            <td className="py-4 text-cyan-600 font-bold">3 à 5 semaines</td>
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4">
                                    <div className="w-10 h-10 bg-cyan-100 rounded-full flex items-center justify-center shrink-0 font-bold text-cyan-600">1</div>
                                    <div>
                                ...
                                <div className="flex gap-4">
                                    <div className="w-10 h-10 bg-cyan-100 rounded-full flex items-center justify-center shrink-0 font-bold text-cyan-600">2</div>
                                    <div>
                                ...
                                <div className="flex gap-4">
                                    <div className="w-10 h-10 bg-cyan-100 rounded-full flex items-center justify-center shrink-0 font-bold text-cyan-600">3</div>
                                    <div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-24">
                            <div className="bg-slate-900 text-white p-8 rounded-2xl shadow-xl text-center">
                                ...
                                <Link href="/devis">
                                    <Button size="lg" className="w-full bg-cyan-500 hover:bg-cyan-600 text-white font-bold h-14 rounded-xl">
