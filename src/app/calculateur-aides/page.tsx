...
export default function CalculateurAides() {
    ...
    const calculateAides = (): AidesResult | null => {
        ...
        // Taux MaPrimeRénov' selon revenus
        ...
        <div className="min-h-screen bg-slate-50">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-3xl mx-auto text-center mt-4">
                        <div className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 text-green-300 px-4 py-1.5 rounded-full text-sm font-medium mb-6">
                            ...
                            Simulation MaPrimeRénov' 2026
                        </div>
                        <h1 className="text-3xl md:text-5xl font-bold mb-4">
                            Calculez vos Aides Financières
                        </h1>
                        <p className="text-xl text-slate-300">
                            MaPrimeRénov', crédit d'impôt, TVA réduite : découvrez votre reste à charge
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    {!showResult ? (
                        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                            <div className="p-6 md:p-8">
                                ...
                                {step === 1 && (
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500 mb-6 flex items-start gap-2">
                                            ...
                                            <span>Pas encore de devis ? <Link href="/simulateur-prix" className="text-cyan-600 underline">Estimez d'abord le prix</Link></span>
                                        </p>
                                        <Button
                                            onClick={() => setStep(2)}
                                ...
                                {step === 4 && (
                                    <div>
                                        <button onClick={() => setStep(3)} className="text-sm text-slate-500 hover:text-cyan-600 mb-4">
                                            ← Retour
                                        </button>
                                        <h2 className="text-2xl font-bold text-slate-900 mb-6">
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className="w-full h-14 px-4 border-2 border-slate-200 rounded-xl focus:border-cyan-500 focus:ring-0 text-lg"
                                                    />
                                        ...
                                        <Button
                                            ...
                                            disabled={revenus <= 0}
                                            className="w-full bg-cyan-600 hover:bg-cyan-700 text-white h-14 text-lg rounded-xl disabled:opacity-50"
                                        >
                                            Calculer mes aides
                                            <ArrowRight className="ml-2 h-5 w-5" />
                                        </Button>
                                ...
                                {result && (
                                    <>
                                        ...
                                        <div className="grid sm:grid-cols-2 gap-4 mb-8">
                                            ...
                                            <div className="bg-cyan-50 rounded-xl p-6 text-center border border-cyan-200">
                                                <div className="text-sm text-cyan-700 mb-1">Reste à charge</div>
                                                <div className="text-3xl font-bold text-cyan-600">{formatPrice(result.resteACharge)}</div>
                                            </div>
                                        </div>
            ...
            <section className="py-16 bg-white border-t border-slate-200">
                <div className="container mx-auto px-4 max-w-3xl prose prose-slate">
                    <h2>Comment fonctionnent les aides pour un climatisation ?</h2>
                    <h3>MaPrimeRénov' (ex-AAH habitat)</h3>
                    <p>
                        <strong>MaPrimeRénov'</strong> est la principale aide de l'État pour l'adaptation du logement au vieillissement ou au handicap.
                    ...
                    <p>
                        Si vous n'êtes pas éligible à MaPrimeRénov', vous pouvez bénéficier d'un <strong>crédit d'impôt de 25%</strong>
                        sur le coût des équipements (plafonné à 5 000€ pour une personne seule, 10 000€ pour un couple).
                    </p>

                    <h3>TVA réduite à 5,5%</h3>
                    <p>
                        L'installation d'un climatisation bénéficie du taux de TVA réduit à 5,5% (au lieu de 20%)
                        si votre logement a plus de 2 ans.
                    </p>

                    <p>
                        <Link href="/guides/remboursement-climatisation-securite-sociale" className="text-cyan-600">
