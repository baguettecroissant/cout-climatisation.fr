...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
    ...
    return {
        title: currentPage > 1
            ? `Guides & Conseils Climatisation - Page ${currentPage} | Cout-Climatisation.fr`
            : "Guides & Conseils Climatisation | Cout-Climatisation.fr",
        description: "Nos dossiers complets pour bien choisir votre climatisation : prix, aides financières, modèles et installation.",
        alternates: {
            canonical: currentPage > 1
                ? `https://www.cout-climatisation.fr/guides?page=${currentPage}`
                : "https://www.cout-climatisation.fr/guides",
        },
    };
}
                    ...
                    <Card key={guide.slug} className="hover:shadow-lg transition-shadow border-slate-200">
                        ...
                        <CardContent>
                            ...
                            <div className="flex justify-between items-center mt-4">
                                ...
                                <Link href={`/guides/${guide.slug}`} className="text-cyan-600 font-medium hover:underline">
                                    Lire l&apos;article &rarr;
                                </Link>
                            </div>
                        </CardContent>
