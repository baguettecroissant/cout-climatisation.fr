...
export const metadata = {
    title: "Mentions Légales & Confidentialité | Cout-Climatisation.fr",
    description: "Mentions légales, éditeur, hébergement et politique de confidentialité du site Cout-Climatisation.fr.",
    robots: {
        index: false,
        follow: false,
    },
        ...
        <div className="bg-slate-50 min-h-screen py-12 md:py-20">
            <div className="container mx-auto px-4 max-w-4xl">
                <div className="mb-8">
                    <Link
                        href="/"
                        className="inline-flex items-center text-slate-600 hover:text-cyan-600 transition-colors font-medium mb-4"
                    >
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <div className="text-slate-600 leading-relaxed">
                                    <p className="mb-2">Le site <strong>cout-climatisation.fr</strong> est édité par la société :</p>
                                    ...
                                    <div className="mt-4">
                                        <p><strong>Email de contact :</strong> contact@cout-climatisation.fr</p>
                            ...
                            <div>
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    L'ensemble de ce site relève de la législation internationale sur le droit d'auteur et la propriété intellectuelle. Tous les droits de reproduction sont réservés. La marque "WADE STUDIO LTD" et le nom de domaine "cout-climatisation.fr" sont la propriété exclusive de l'éditeur.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="text-slate-600 leading-relaxed space-y-4">
                                    <p>
                                        Le site cout-climatisation.fr agit en tant qu'intermédiaire technique (apporteur d'affaires). Il a pour but de faciliter la mise en relation entre des particuliers et des professionnels du bâtiment via des partenaires affiliés.
                                    </p>
                                    <p>
                            ...
                            <div>
                                ...
                                <div className="bg-blue-50 p-4 rounded-lg flex items-start gap-3">
                                    ...
                                    <p className="text-blue-900 text-sm">
                                        Pour exercer ce droit, contactez-nous à : <strong>contact@cout-climatisation.fr</strong> ou par courrier à notre siège social.
                                    </p>
                                </div>
                            </div>
